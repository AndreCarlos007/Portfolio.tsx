...
export default function Home() {
  return (
    ...
    >
      <div className="sm:pl-10 sm:pt-28 sm:max-w-[320px] md:max-w-[600px] md:pl-[5.3rem] md:pt-36 lg:pt-44 flex flex-col gap-5 z-[50] ">
        ...
        <p className="text-gray-200 hidden sm:block md:block md:text-[1.3rem] lg:text-[1.4rem]">
        I create digital solutions that prioritize both aesthetics and usability. 
        </p>
        <div className="flex-col md:flex-row hidden md:flex gap-5">
          <Link
            href="/my-skills"
            className="px-6 py-2 font-medium bg-gradient-to-r from-purple-900 to-red-000 text-white w-fit transition-all shadow-[1px_1px_0px_white] hover:shadow-none hover:translate-x-[3px] hover:translate-y-[3px] rounded-md max-w-[200px]"
          >
            Learn more
          </Link>
          <Link
    ...
    <div className="absolute bottom-0 right-0 z-[10]">
      <Image
        ...
        height={200}
        width={115}
        className="absolute right-48 top-40 md:w-[350px] md:top-32 md:right-44 lg:top-4 lg:right-72"
      />
      ...
      width={310} 
      height={400}
      className="md:w-[500px] lg:w-[600px] lg:h-[600px]"
      />
    </div>
