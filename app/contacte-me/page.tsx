        ...
        <div className='flex flex-col w-full max-w-[300px] sm:max-w-[340px] md:max-w-[600px] mt-72 mb-36 sm:mt-36 md:mt-0 md:mb-0'>
            ...
            <form className=' text-white flex-1 flex flex-col gap-6 w-full mx-auto' action="">
                <div className='flex gap-x-6 w-full'>
                    ...
                    <input type="email" placeholder='email' name="email" className='w-full h-[40px] rounded-lg pl-6 bg-transparent border border-white/10 outline-none focus:ring-1 focus:ring-purple-800 placeholder:text-white/30 placeholder:font-light' />
                </div>
